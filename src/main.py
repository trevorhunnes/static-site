...
def generate_pages_recursive(dir_path_content, template_path, dest_dir_path, basepath):
    ...
    walk(content_path, content_path, dest_path, template, basepath)


def walk(current_dir, content_root, dest_root, template, basepath):
    for entry in current_dir.iterdir():
        if entry.is_dir():
            walk(entry, content_root, dest_root, template, basepath)
            ...
            generate_page(str(entry), str(template), str(out_path), basepath)
